...
function getAutomaticActionInstruction(documentAction: AiChatDocumentAction | null) {
  if (documentAction === "edit_blocks") {
    return [
      ...
      "If the user asks to shorten, polish, rewrite, or replace the current English translation/英文翻译/英文版, target the existing English translation content block and use replace_block. Do not return the original text, comparison prose, or a full rewritten document.",
