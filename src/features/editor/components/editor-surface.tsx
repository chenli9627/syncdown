  ...
  return (
    ...
    >
      ...
      {model.canEditBody && !aiChatOpen ? (
        <button
          className="fixed bottom-5 right-5 z-30 inline-flex h-11 w-11 items-center justify-center rounded-full border shadow-[var(--shadow-soft-card)] transition hover:brightness-95"
